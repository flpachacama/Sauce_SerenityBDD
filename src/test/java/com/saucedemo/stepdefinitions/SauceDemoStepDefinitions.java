...
public class SauceDemoStepDefinitions {
    ...
    public void addProducts(DataTable dataTable) {
        ...
        selectedProducts = rows.stream().map(row -> row.get("producto")).collect(Collectors.toList());
    ...
    public void openCart() {
        ...
        comprador.should(seeThat(ProductsInCart.names(), containsInAnyOrder(selectedProducts.toArray(new String[0]))));
    }
